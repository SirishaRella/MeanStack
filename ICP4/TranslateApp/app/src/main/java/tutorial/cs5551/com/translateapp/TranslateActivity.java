...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void translateText(View v) {
        ...
        /** Getting the value of selected spinner item and taking the two characters of the string to identify the language**/
        Spinner spinner = (Spinner) findViewById(R.id.language_spinner);
        String selectedLanguage = spinner.getSelectedItem().toString().substring(0, 2);
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang=en-" + selectedLanguage + "&[format=plain]&[options=1]&[callback=set]";//The API service URL
    ...
    /** Logout function triggers on clicking logout button and toastmessage is displayed accordingly navigating to the login page**/
